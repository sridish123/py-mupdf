...
class Document(object):
    ...
    def __init__(
        self,
        filename: "char const *" = None,
        stream: "PyObject *" = None,
        filetype: "char const *" = None,
        rect: "PyObject *" = None,
        width: "float" = 0,
        height: "float" = 0,
        fontsize: "float" = 11,
    ...
    def update_object(
        self, xref: "int", text: "char *", page: "Page" = None
    ) -> "PyObject *":
    ...
    def update_stream(
        self, xref: "int" = 0, stream: "PyObject *" = None, new: "int" = 0
    ) -> "PyObject *":
    ...
    def _update_toc_item(
        self, xref: "int", action: "char *" = None, title: "char *" = None
    ) -> "PyObject *":
    ...
    def set_layer(
        self,
        config: "int",
        basestate: "char const *" = None,
        on: "PyObject *" = None,
        off: "PyObject *" = None,
        rbgroups: "PyObject *" = None,
    ) -> "PyObject *":
    ...
    def add_layer(
        self, name: "char *", creator: "char *" = None, on: "PyObject *" = None
    ) -> "PyObject *":
        """Add a new OC layer."""
        if self.isClosed:
            raise ValueError("document closed")
    ...
    def add_ocg(
        ...
        config: "int" = -1,
        on: "int" = 1,
        intent: "PyObject *" = None,
        usage: "char const *" = None,
    ) -> "PyObject *":
...
class Page(object):
    ...
    def _get_text_page(
        self, clip: "PyObject *" = None, flags: "int" = 0
    ) -> "struct TextPage *":
    ...
    def getSVGimage(
        self, matrix: "PyObject *" = None, text_as_path: "int" = 1
    ) -> "PyObject *":
    ...
    def _set_opacity(
        self, gstate: "char *" = None, CA: "float" = 1, ca: "float" = 1
    ) -> "PyObject *":
    ...
    def _add_redact_annot(
        ...
        quad: "PyObject *",
        text: "char *" = None,
        da_str: "char const *" = None,
        align: "int" = 0,
        fill: "PyObject *" = None,
        text_color: "PyObject *" = None,
    ) -> "struct Annot *":
    ...
    def _add_text_annot(
        self, point: "PyObject *", text: "char *", icon: "char *" = None
    ) -> "struct Annot *":
    ...
    def _add_stamp_annot(
        self, rect: "PyObject *", stamp: "int" = 0
    ) -> "struct Annot *":
    ...
    def _add_text_marker(
        self, quads: "PyObject *", annot_type: "int"
    ) -> "struct Annot *":
    ...
    def _add_square_or_circle(
        self, rect: "PyObject *", annot_type: "int"
    ) -> "struct Annot *":
        return _fitz.Page__add_square_or_circle(self, rect, annot_type)

    def _add_multiline(
        self, points: "PyObject *", annot_type: "int"
    ) -> "struct Annot *":
    ...
    def _insertImage(
        ...
        xref: "int" = 0,
        matrix: "PyObject *" = None,
        _imgname: "char const *" = None,
        _imgpointer: "PyObject *" = None,
    ) -> "PyObject *":
...
class Pixmap(object):
    ...
    def setAlpha(
        self, alphavalues: "PyObject *" = None, premultiply: "int" = 1
    ) -> "PyObject *":
...
class Annot(object):
    ...
    def set_colors(
        self,
        colors: "PyObject *" = None,
        fill: "PyObject *" = None,
        stroke: "PyObject *" = None,
    ) -> "void":
    ...
    def set_border(
        self,
        border: "PyObject *" = None,
        width: "float" = 0,
        style: "char *" = None,
        dashes: "PyObject *" = None,
    ) -> "PyObject *":
...
class Link(object):
    ...
    def _setBorder(
        self, border: "PyObject *", doc: "Document", xref: "int"
    ) -> "PyObject *":
    ...
    def _setColors(
        self, colors: "PyObject *", doc: "Document", xref: "int"
    ) -> "PyObject *":
...
class TextPage(object):
    ...
    def search(
        self, needle: "char const *", hit_max: "int" = 0, quads: "int" = 1
    ) -> "PyObject *":
    ...
    def extractSelection(
        self, pointa: "PyObject *", pointb: "PyObject *"
    ) -> "PyObject *":
...
class TextWriter(object):
    ...
    def __init__(
        self, page_rect: "PyObject *", opacity: "float" = 1, color: "PyObject *" = None
    ):
...
class Font(object):
    ...
    def glyph_advance(
        self, chr: "int", language: "char *" = None, script: "int" = 0, wmode: "int" = 0
    ) -> "float":
    ...
    def glyph_bbox(
        self, chr: "int", language: "char *" = None, script: "int" = 0
    ) -> "PyObject *":
...
class Tools(object):
    ...
    def image_profile(
        self, stream: "PyObject *", keep_image: "int" = 0
    ) -> "PyObject *":
    ...
    def _insert_contents(
        self, page: "Page", newcont: "PyObject *", overlay: "int" = 1
    ) -> "PyObject *":
    ...
    def _transform_point(
        self, point: "PyObject *", matrix: "PyObject *"
    ) -> "PyObject *":
    ...
    def _sine_between(
        self, C: "PyObject *", P: "PyObject *", Q: "PyObject *"
    ) -> "PyObject *":
