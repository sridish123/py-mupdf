...
class Document(object):
    ...
    def __init__(self, filename: "char const *"=None, stream: "PyObject *"=None, filetype: "char const *"=None, rect: "PyObject *"=None, width: "float"=0, height: "float"=0, fontsize: "float"=11):
    ...
    def loadPage(self, page_id: "PyObject *") -> "struct Page *":
    ...
    def _remove_links_to(self, first: "int", last: "int") -> "PyObject *":
        return _fitz.Document__remove_links_to(self, first, last)

    def _loadOutline(self) -> "struct Outline *":
        """Load first outline."""
        if self.isClosed:
            raise ValueError("document closed")
    ...
    def _dropOutline(self, ol: "Outline") -> "void":
        return _fitz.Document__dropOutline(self, ol)

    def _embeddedFileNames(self, namelist: "PyObject *") -> "PyObject *":
    ...
    def _embeddedFileDel(self, idx: "int") -> "PyObject *":
        return _fitz.Document__embeddedFileDel(self, idx)

    def _embeddedFileInfo(self, idx: "int", infodict: "PyObject *") -> "PyObject *":
        return _fitz.Document__embeddedFileInfo(self, idx, infodict)

    def _embeddedFileUpd(self, idx: "int", buffer: "PyObject *"=None, filename: "char *"=None, ufilename: "char *"=None, desc: "char *"=None) -> "PyObject *":
        return _fitz.Document__embeddedFileUpd(self, idx, buffer, filename, ufilename, desc)

    def _embeddedFileGet(self, idx: "int") -> "PyObject *":
        return _fitz.Document__embeddedFileGet(self, idx)

    def _embeddedFileAdd(self, name: "char const *", buffer: "PyObject *", filename: "char *"=None, ufilename: "char *"=None, desc: "char *"=None) -> "PyObject *":
    ...
    def convertToPDF(self, from_page: "int"=0, to_page: "int"=-1, rotate: "int"=0) -> "PyObject *":
    ...
    def get_oc(self, xref: "int") -> "PyObject *":
    ...
    def set_oc(self, xref: "int", oc: "int") -> "PyObject *":
    ...
    def chapterCount(self) -> "PyObject *":
        """Number of chapters."""
        if self.isClosed:
            raise ValueError("document closed")
    ...
    def lastLocation(self) -> "PyObject *":
    ...
    def chapterPageCount(self, chapter: "int") -> "PyObject *":
    ...
    def previousLocation(self, page_id: "PyObject *") -> "PyObject *":
    ...
    def nextLocation(self, page_id: "PyObject *") -> "PyObject *":
    ...
    def location_from_page_number(self, pno: "int") -> "PyObject *":
    ...
    def page_number_from_location(self, page_id: "PyObject *") -> "PyObject *":
    ...
    def _getMetadata(self, key: "char const *") -> "PyObject *":
        """Get metadata."""
        if self.isClosed:
            raise ValueError("document closed")
    ...
    def setLanguage(self, language: "char *"=None) -> "PyObject *":
        return _fitz.Document_setLanguage(self, language)

    def resolveLink(self, uri: "char *"=None, chapters: "int"=0) -> "PyObject *":
    ...
    def layout(self, rect: "PyObject *"=None, width: "float"=0, height: "float"=0, fontsize: "float"=11) -> "PyObject *":
    ...
    def makeBookmark(self, loc: "PyObject *") -> "PyObject *":
    ...
    def findBookmark(self, bm: "PyObject *") -> "PyObject *":
    ...
    def isReflowable(self) -> "PyObject *":
    ...
    def _deleteObject(self, xref: "int") -> "PyObject *":
        """Delete object."""
        if self.isClosed:
            raise ValueError("document closed")
    ...
    def _getPDFfileid(self) -> "PyObject *":
        """Get PDF file id."""
        if self.isClosed:
            raise ValueError("document closed")
    ...
    def _hasXrefStream(self) -> "PyObject *":
    ...
    def _hasXrefOldStyle(self) -> "PyObject *":
    ...
    def can_save_incrementally(self) -> "PyObject *":
    ...
    def authenticate(self, password: "char *") -> "PyObject *":
        """Decrypt document."""
        if self.isClosed:
            raise ValueError("document closed")
    ...
    def save(self, filename: "char *", garbage: "int"=0, clean: "int"=0, deflate: "int"=0, deflate_images: "int"=0, deflate_fonts: "int"=0, incremental: "int"=0, ascii: "int"=0, expand: "int"=0, linear: "int"=0, pretty: "int"=0, encryption: "int"=1, permissions: "int"=-1, owner_pw: "char *"=None, user_pw: "char *"=None) -> "PyObject *":
    ...
    def write(self, garbage: "int"=0, clean: "int"=0, deflate: "int"=0, deflate_images: "int"=0, deflate_fonts: "int"=0, ascii: "int"=0, expand: "int"=0, pretty: "int"=0, encryption: "int"=1, permissions: "int"=-1, owner_pw: "char *"=None, user_pw: "char *"=None) -> "PyObject *":
    ...
    def insertPDF(self, docsrc: "Document", from_page: "int"=-1, to_page: "int"=-1, start_at: "int"=-1, rotate: "int"=-1, links: "int"=1, annots: "int"=1, show_progress: "int"=0, final: "int"=1, _gmap: "Graftmap"=None) -> "PyObject *":
    ...
    def _newPage(self, pno: "int"=-1, width: "float"=595, height: "float"=842) -> "PyObject *":
        """Make a new PDF page."""
        if self.isClosed or self.isEncrypted:
            raise ValueError("document closed or encrypted")
    ...
    def select(self, pyliste: "PyObject *") -> "PyObject *":
    ...
    def _deletePage(self, pno: "int") -> "PyObject *":
        return _fitz.Document__deletePage(self, pno)
    @property

    def permissions(self) -> "PyObject *":
    ...
    def _getCharWidths(self, xref: "int", bfname: "char *", ext: "char *", ordering: "int", limit: "int", idx: "int"=0) -> "PyObject *":
    ...
    def page_xref(self, pno: "int") -> "PyObject *":
    ...
    def pageCropBox(self, pno: "int") -> "PyObject *":
    ...
    def _getPageInfo(self, pno: "int", what: "int") -> "PyObject *":
    ...
    def extractFont(self, xref: "int"=0, info_only: "int"=0) -> "PyObject *":
        """Get a font by xref."""
        if self.isClosed or self.isEncrypted:
            raise ValueError("document closed or encrypted")
    ...
    def extractImage(self, xref: "int") -> "PyObject *":
    ...
    def outlineXref(self, index: "int") -> "int":
    ...
    def isStream(self, xref: "int"=0) -> "PyObject *":
    ...
    def need_appearances(self, value: "PyObject *"=None) -> "PyObject *":
    ...
    def _addFormFont(self, name: "char *", font: "char *") -> "PyObject *":
        """Add new form font."""
        if self.isClosed or self.isEncrypted:
            raise ValueError("document closed or encrypted")
    ...
    def _getOLRootNumber(self) -> "PyObject *":
    ...
    def get_new_xref(self) -> "PyObject *":
        """Make new xref."""
        if self.isClosed or self.isEncrypted:
            raise ValueError("document closed or encrypted")
    ...
    def getXmlMetadata(self) -> "PyObject *":
    ...
    def xref_xml_metadata(self) -> "PyObject *":
    ...
    def del_xml_metadata(self) -> "PyObject *":
        """Delete XML metadata."""
        if self.isClosed or self.isEncrypted:
            raise ValueError("document closed or encrypted")
    ...
    def set_xml_metadata(self, metadata: "char *") -> "PyObject *":
    ...
    def xref_object(self, xref: "int", compressed: "int"=0, ascii: "int"=0) -> "PyObject *":
    ...
    def pdf_trailer(self, compressed: "int"=0, ascii: "int"=0) -> "PyObject *":
    ...
    def xref_stream_raw(self, xref: "int") -> "PyObject *":
    ...
    def xref_stream(self, xref: "int") -> "PyObject *":
    ...
    def update_object(self, xref: "int", text: "char *", page: "Page"=None) -> "PyObject *":
    ...
    def update_stream(self, xref: "int"=0, stream: "PyObject *"=None, new: "int"=0) -> "PyObject *":
    ...
    def _setMetadata(self, text: "char *") -> "PyObject *":
    ...
    def _make_page_map(self) -> "PyObject *":
    ...
    def fullcopyPage(self, pno: "int", to: "int"=-1) -> "PyObject *":
    ...
    def _move_copy_page(self, pno: "int", nb: "int", before: "int", copy: "int") -> "PyObject *":
    ...
    def _remove_toc_item(self, xref: "int") -> "PyObject *":
        return _fitz.Document__remove_toc_item(self, xref)

    def _update_toc_item(self, xref: "int", action: "char *"=None, title: "char *"=None) -> "PyObject *":
        return _fitz.Document__update_toc_item(self, xref, action, title)

    def _get_page_labels(self) -> "PyObject *":
        return _fitz.Document__get_page_labels(self)

    def _set_page_labels(self, labels: "char *") -> "PyObject *":
    ...
    def switch_layer(self, config: "int", as_default: "int"=0) -> "PyObject *":
    ...
    def get_layer(self, config: "int"=-1) -> "PyObject *":
    ...
    def set_layer(self, config: "int", basestate: "char const *"=None, on: "PyObject *"=None, off: "PyObject *"=None, rbgroups: "PyObject *"=None) -> "PyObject *":
    ...
    def add_layer(self, name: "char *", creator: "char *"=None, on: "PyObject *"=None) -> "PyObject *":
        """Add a new OC layer."""
        if self.isClosed:
            raise ValueError("document closed")
    ...
    def layer_ui_configs(self) -> "PyObject *":
    ...
    def set_layer_ui_config(self, number: "int", action: "int"=0) -> "PyObject *":
    ...
    def add_ocg(self, name: "char *", config: "int"=-1, on: "int"=1, intent: "PyObject *"=None, usage: "char const *"=None) -> "PyObject *":
...
class Page(object):
    ...
    def getImageBbox(self, name: "PyObject *") -> "PyObject *":
    ...
    def run(self, dw: "Device", m: "PyObject *") -> "PyObject *":
    ...
    def _get_text_page(self, clip: "PyObject *"=None, flags: "int"=0) -> "struct TextPage *":
    ...
    def getSVGimage(self, matrix: "PyObject *"=None, text_as_path: "int"=1) -> "PyObject *":
    ...
    def _set_opacity(self, gstate: "char *"=None, CA: "float"=1, ca: "float"=1) -> "PyObject *":
    ...
    def _add_caret_annot(self, point: "PyObject *") -> "struct Annot *":
        return _fitz.Page__add_caret_annot(self, point)

    def _add_redact_annot(self, quad: "PyObject *", text: "char *"=None, da_str: "char const *"=None, align: "int"=0, fill: "PyObject *"=None, text_color: "PyObject *"=None) -> "struct Annot *":
        return _fitz.Page__add_redact_annot(self, quad, text, da_str, align, fill, text_color)

    def _add_line_annot(self, p1: "PyObject *", p2: "PyObject *") -> "struct Annot *":
        return _fitz.Page__add_line_annot(self, p1, p2)

    def _add_text_annot(self, point: "PyObject *", text: "char *", icon: "char *"=None) -> "struct Annot *":
        return _fitz.Page__add_text_annot(self, point, text, icon)

    def _add_ink_annot(self, list: "PyObject *") -> "struct Annot *":
        return _fitz.Page__add_ink_annot(self, list)

    def _add_stamp_annot(self, rect: "PyObject *", stamp: "int"=0) -> "struct Annot *":
        return _fitz.Page__add_stamp_annot(self, rect, stamp)

    def _add_file_annot(self, point: "PyObject *", buffer: "PyObject *", filename: "char *", ufilename: "char *"=None, desc: "char *"=None, icon: "char *"=None) -> "struct Annot *":
        return _fitz.Page__add_file_annot(self, point, buffer, filename, ufilename, desc, icon)

    def _add_text_marker(self, quads: "PyObject *", annot_type: "int") -> "struct Annot *":
    ...
    def _add_square_or_circle(self, rect: "PyObject *", annot_type: "int") -> "struct Annot *":
        return _fitz.Page__add_square_or_circle(self, rect, annot_type)

    def _add_multiline(self, points: "PyObject *", annot_type: "int") -> "struct Annot *":
        return _fitz.Page__add_multiline(self, points, annot_type)

    def _add_freetext_annot(self, rect: "PyObject *", text: "char *", fontsize: "float"=11, fontname: "char *"=None, text_color: "PyObject *"=None, fill_color: "PyObject *"=None, align: "int"=0, rotate: "int"=0) -> "struct Annot *":
    ...
    def _load_annot(self, name: "char *", xref: "int") -> "struct Annot *":
        return _fitz.Page__load_annot(self, name, xref)

    def _get_resource_properties(self) -> "PyObject *":
        return _fitz.Page__get_resource_properties(self)

    def _set_resource_property(self, name: "char *", xref: "int") -> "PyObject *":
    ...
    def _addWidget(self, field_type: "int", field_name: "char *") -> "struct Annot *":
        return _fitz.Page__addWidget(self, field_type, field_name)

    def getDisplayList(self, annots: "int"=1) -> "struct DisplayList *":
    ...
    def _getDrawings(self) -> "PyObject *":
        return _fitz.Page__getDrawings(self)

    def _apply_redactions(self, *args) -> "PyObject *":
        return _fitz.Page__apply_redactions(self, *args)

    def _makePixmap(self, doc: "Document", ctm: "PyObject *", cs: "Colorspace", alpha: "int"=0, annots: "int"=1, clip: "PyObject *"=None) -> "struct Pixmap *":
        return _fitz.Page__makePixmap(self, doc, ctm, cs, alpha, annots, clip)

    def setMediaBox(self, rect: "PyObject *") -> "PyObject *":
        """Set the MediaBox."""
        CheckParent(self)
    ...
    def setCropBox(self, rect: "PyObject *") -> "PyObject *":
        """Set the CropBox."""
        CheckParent(self)
    ...
    def loadLinks(self) -> "struct Link *":
        """Get first Link."""
        CheckParent(self)
    ...
    def firstAnnot(self) -> "struct Annot *":
        """First annotation."""
        CheckParent(self)
    ...
    def firstWidget(self) -> "struct Annot *":
        """First widget/field."""
        CheckParent(self)
    ...
    def deleteLink(self, linkdict: "PyObject *") -> "void":
        """Delete a Link."""
        CheckParent(self)
    ...
    def deleteAnnot(self, annot: "Annot") -> "struct Annot *":
    ...
    def setRotation(self, rotation: "int") -> "PyObject *":
        """Set page rotation."""
        CheckParent(self)
    ...
    def _addAnnot_FromString(self, linklist: "PyObject *") -> "PyObject *":
    ...
    def _getLinkXrefs(self) -> "PyObject *":
        return _fitz.Page__getLinkXrefs(self)

    def clean_contents(self, sanitize: "int"=1) -> "PyObject *":
    ...
    def _showPDFpage(self, fz_srcpage: "Page", overlay: "int"=1, matrix: "PyObject *"=None, xref: "int"=0, oc: "int"=0, clip: "PyObject *"=None, graftmap: "Graftmap"=None, _imgname: "char *"=None) -> "PyObject *":
        return _fitz.Page__showPDFpage(self, fz_srcpage, overlay, matrix, xref, oc, clip, graftmap, _imgname)

    def _insertImage(self, filename: "char const *"=None, pixmap: "Pixmap"=None, stream: "PyObject *"=None, imask: "PyObject *"=None, overlay: "int"=1, oc: "int"=0, xref: "int"=0, matrix: "PyObject *"=None, _imgname: "char const *"=None, _imgpointer: "PyObject *"=None) -> "PyObject *":
        return _fitz.Page__insertImage(self, filename, pixmap, stream, imask, overlay, oc, xref, matrix, _imgname, _imgpointer)

    def refresh(self) -> "PyObject *":
    ...
    def _insertFont(self, fontname: "char *", bfname: "char *", fontfile: "char *", fontbuffer: "PyObject *", set_simple: "int", idx: "int", wmode: "int", serif: "int", encoding: "int", ordering: "int") -> "PyObject *":
        return _fitz.Page__insertFont(self, fontname, bfname, fontfile, fontbuffer, set_simple, idx, wmode, serif, encoding, ordering)
    @property

    def transformationMatrix(self) -> "PyObject *":
    ...
    def get_contents(self) -> "PyObject *":
    ...
    def set_contents(self, xref: "int") -> "PyObject *":
...
class Pixmap(object):
    ...
    def shrink(self, factor: "int") -> "void":
    ...
    def _getImageData(self, format: "int") -> "PyObject *":
    ...
    def _writeIMG(self, filename: "char *", format: "int") -> "PyObject *":
    ...
    def invertIRect(self, bbox: "PyObject *"=None) -> "PyObject *":
        """Invert the colors inside a bbox."""

        return _fitz.Pixmap_invertIRect(self, bbox)


    def pixel(self, x: "int", y: "int") -> "PyObject *":
    ...
    def setPixel(self, x: "int", y: "int", color: "PyObject *") -> "PyObject *":
        """Set color of pixel (x, y)."""

        return _fitz.Pixmap_setPixel(self, x, y, color)


    def setOrigin(self, x: "int", y: "int") -> "PyObject *":
        """Set top-left coordinates."""

        return _fitz.Pixmap_setOrigin(self, x, y)


    def setResolution(self, xres: "int", yres: "int") -> "PyObject *":
    ...
    def setRect(self, bbox: "PyObject *", color: "PyObject *") -> "PyObject *":
    ...
    def colorspace(self) -> "struct Colorspace *":
        """Pixmap Colorspace."""
...
class Outline(object):
    ...
    def uri(self) -> "PyObject *":
        return _fitz.Outline_uri(self)
    @property

    def next(self) -> "struct Outline *":
        return _fitz.Outline_next(self)
    @property

    def down(self) -> "struct Outline *":
        return _fitz.Outline_down(self)
    @property

    def isExternal(self) -> "PyObject *":
    ...
    def title(self) -> "PyObject *":
        return _fitz.Outline_title(self)
    @property

    def is_open(self) -> "PyObject *":
...
class Annot(object):
    ...
    def set_apn_matrix(self, matrix: "PyObject *") -> "PyObject *":
    ...
    def set_apn_bbox(self, bbox: "PyObject *") -> "PyObject *":
    ...
    def set_blendmode(self, blend_mode: "char *") -> "PyObject *":
    ...
    def set_open(self, is_open: "int") -> "PyObject *":
    ...
    def set_popup(self, rect: "PyObject *") -> "PyObject *":
    ...
    def set_oc(self, oc: "int"=0) -> "PyObject *":
    ...
    def set_language(self, language: "char *"=None) -> "PyObject *":
    ...
    def _getAP(self) -> "PyObject *":
        return _fitz.Annot__getAP(self)

    def _setAP(self, ap: "PyObject *", rect: "int"=0) -> "PyObject *":
        return _fitz.Annot__setAP(self, ap, rect)

    def _get_redact_values(self) -> "PyObject *":
    ...
    def get_textpage(self, clip: "PyObject *"=None, flags: "int"=0) -> "struct TextPage *":
    ...
    def set_name(self, name: "char *") -> "PyObject *":
    ...
    def set_rect(self, rect: "PyObject *") -> "PyObject *":
    ...
    def set_rotation(self, rotate: "int"=0) -> "PyObject *":
    ...
    def _update_appearance(self, opacity: "float"=-1, blend_mode: "char *"=None, fill_color: "PyObject *"=None, rotate: "int"=-1) -> "PyObject *":
    ...
    def set_colors(self, colors: "PyObject *"=None, fill: "PyObject *"=None, stroke: "PyObject *"=None) -> "void":
    ...
    def set_line_ends(self, start: "int", end: "int") -> "void":
        """Set line end codes."""
        CheckParent(self)
    ...
    def set_opacity(self, opacity: "float") -> "void":
        """Set opacity."""
        CheckParent(self)
    ...
    def update_file(self, buffer: "PyObject *"=None, filename: "char *"=None, ufilename: "char *"=None, desc: "char *"=None) -> "PyObject *":
    ...
    def set_info(self, info: "PyObject *"=None, content: "char *"=None, title: "char *"=None, creationDate: "char *"=None, modDate: "char *"=None, subject: "char *"=None) -> "PyObject *":
    ...
    def set_border(self, border: "PyObject *"=None, width: "float"=0, style: "char *"=None, dashes: "PyObject *"=None) -> "PyObject *":
    ...
    def set_flags(self, flags: "int") -> "void":
    ...
    def delete_responses(self) -> "PyObject *":
    ...
    def get_pixmap(self, matrix: "PyObject *"=None, colorspace: "Colorspace"=None, alpha: "int"=0) -> "struct Pixmap *":
        """annotation Pixmap"""
...
class Link(object):
    ...
    def _border(self, doc: "Document", xref: "int") -> "PyObject *":
        return _fitz.Link__border(self, doc, xref)

    def _setBorder(self, border: "PyObject *", doc: "Document", xref: "int") -> "PyObject *":
        return _fitz.Link__setBorder(self, border, doc, xref)

    def _colors(self, doc: "Document", xref: "int") -> "PyObject *":
        return _fitz.Link__colors(self, doc, xref)

    def _setColors(self, colors: "PyObject *", doc: "Document", xref: "int") -> "PyObject *":
...
class DisplayList(object):
    ...
    def __init__(self, mediabox: "PyObject *"):
        _fitz.DisplayList_swiginit(self, _fitz.new_DisplayList(mediabox))
        self.thisown = True



    def run(self, dw: "Device", m: "PyObject *", area: "PyObject *") -> "PyObject *":
    ...
    def getPixmap(self, matrix: "PyObject *"=None, colorspace: "Colorspace"=None, alpha: "int"=0, clip: "PyObject *"=None) -> "struct Pixmap *":
    ...
    def getTextPage(self, flags: "int"=3) -> "struct TextPage *":
...
class TextPage(object):
    ...
    def search(self, needle: "char const *", hit_max: "int"=0, quads: "int"=1) -> "PyObject *":
    ...
    def _getNewBlockList(self, page_dict: "PyObject *", raw: "int") -> "PyObject *":
    ...
    def _extractText(self, format: "int") -> "PyObject *":
        return _fitz.TextPage__extractText(self, format)

    def extractSelection(self, pointa: "PyObject *", pointb: "PyObject *") -> "PyObject *":
...
class TextWriter(object):
    ...
    def __init__(self, page_rect: "PyObject *", opacity: "float"=1, color: "PyObject *"=None):
    ...
    def append(self, pos: "PyObject *", text: "char *", font: "Font"=None, fontsize: "float"=11, language: "char *"=None) -> "PyObject *":
    ...
    def writeText(self, page: "Page", color: "PyObject *"=None, opacity: "float"=-1, overlay: "int"=1, morph: "PyObject *"=None, render_mode: "int"=0, oc: "int"=0) -> "PyObject *":
...
class Font(object):
    ...
    def __init__(self, fontname: "char *"=None, fontfile: "char *"=None, fontbuffer: "PyObject *"=None, script: "int"=0, language: "char *"=None, ordering: "int"=-1, is_bold: "int"=0, is_italic: "int"=0, is_serif: "int"=0):
    ...
    def glyph_advance(self, chr: "int", language: "char *"=None, script: "int"=0, wmode: "int"=0) -> "float":
        """Return the glyph width of a unicode (font size 1)."""

        return _fitz.Font_glyph_advance(self, chr, language, script, wmode)


    def glyph_bbox(self, chr: "int", language: "char *"=None, script: "int"=0) -> "PyObject *":
    ...
    def has_glyph(self, chr: "int", language: "char *"=None, script: "int"=0, fallback: "int"=0) -> "PyObject *":
    ...
    def _valid_unicodes(self, arr: "PyObject *") -> "void":
        return _fitz.Font__valid_unicodes(self, arr)
    @property

    def flags(self) -> "PyObject *":
        return _fitz.Font_flags(self)
    @property

    def isWritable(self) -> "PyObject *":
        return _fitz.Font_isWritable(self)
    @property

    def name(self) -> "PyObject *":
    ...
    def buffer(self) -> "PyObject *":
        return _fitz.Font_buffer(self)
    @property

    def bbox(self) -> "PyObject *":
...
class Tools(object):
    ...
    def store_maxsize(self) -> "PyObject *":
        """MuPDF store size limit."""

        return _fitz.Tools_store_maxsize(self)


    def show_aa_level(self) -> "PyObject *":
    ...
    def _save_widget(self, annot: "Annot", widget: "PyObject *") -> "PyObject *":
        return _fitz.Tools__save_widget(self, annot, widget)

    def _reset_widget(self, annot: "Annot") -> "PyObject *":
        return _fitz.Tools__reset_widget(self, annot)

    def _parse_da(self, annot: "Annot") -> "PyObject *":
    ...
    def _update_da(self, annot: "Annot", da_str: "char *") -> "PyObject *":
        return _fitz.Tools__update_da(self, annot, da_str)

    def _get_all_contents(self, fzpage: "Page") -> "PyObject *":
        """Concatenate all /Contents objects of a page into a bytes object."""

        return _fitz.Tools__get_all_contents(self, fzpage)


    def _insert_contents(self, page: "Page", newcont: "PyObject *", overlay: "int"=1) -> "PyObject *":
    ...
    def mupdf_version(self) -> "PyObject *":
        """Get version of MuPDF binary build."""

        return _fitz.Tools_mupdf_version(self)


    def mupdf_warnings(self, reset: "int"=1) -> "PyObject *":
    ...
    def _int_from_language(self, language: "char *") -> "int":
        return _fitz.Tools__int_from_language(self, language)

    def reset_mupdf_warnings(self) -> "void":
        """Empty the MuPDF warnings/errors store."""

        return _fitz.Tools_reset_mupdf_warnings(self)


    def mupdf_display_errors(self, value: "PyObject *"=None) -> "PyObject *":
        """Set MuPDF error display to True or False."""

        return _fitz.Tools_mupdf_display_errors(self, value)


    def _transform_rect(self, rect: "PyObject *", matrix: "PyObject *") -> "PyObject *":
        return _fitz.Tools__transform_rect(self, rect, matrix)

    def _intersect_rect(self, r1: "PyObject *", r2: "PyObject *") -> "PyObject *":
        return _fitz.Tools__intersect_rect(self, r1, r2)

    def _include_point_in_rect(self, r: "PyObject *", p: "PyObject *") -> "PyObject *":
        return _fitz.Tools__include_point_in_rect(self, r, p)

    def _transform_point(self, point: "PyObject *", matrix: "PyObject *") -> "PyObject *":
        return _fitz.Tools__transform_point(self, point, matrix)

    def _union_rect(self, r1: "PyObject *", r2: "PyObject *") -> "PyObject *":
        return _fitz.Tools__union_rect(self, r1, r2)

    def _concat_matrix(self, m1: "PyObject *", m2: "PyObject *") -> "PyObject *":
        return _fitz.Tools__concat_matrix(self, m1, m2)

    def _invert_matrix(self, matrix: "PyObject *") -> "PyObject *":
        return _fitz.Tools__invert_matrix(self, matrix)

    def _measure_string(self, text: "char const *", fontname: "char const *", fontsize: "float", encoding: "int"=0) -> "float":
        return _fitz.Tools__measure_string(self, text, fontname, fontsize, encoding)

    def _sine_between(self, C: "PyObject *", P: "PyObject *", Q: "PyObject *") -> "PyObject *":
        return _fitz.Tools__sine_between(self, C, P, Q)

    def _hor_matrix(self, C: "PyObject *", P: "PyObject *") -> "PyObject *":
        return _fitz.Tools__hor_matrix(self, C, P)

    def set_font_width(self, doc: "Document", xref: "int", width: "int") -> "PyObject *":
