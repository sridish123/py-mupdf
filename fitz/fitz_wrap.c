...
SWIGINTERN PyObject *fz_document_s_layout(struct fz_document_s *self,PyObject *rect,float width,float height,float fontsize){
            if (!fz_is_document_reflowable(gctx, self)) Py_RETURN_NONE;
            fz_try(gctx)
            {
                float w = width, h = height;
                fz_rect r = JM_rect_from_py(rect);
...
SWIGINTERN PyObject *fz_document_s__getXrefString(struct fz_document_s *self,int xref,int compressed){
            pdf_document *pdf = pdf_specifics(gctx, self); // conv doc to pdf
            pdf_obj *obj = NULL;
            fz_buffer *res = NULL;
            fz_output *out = NULL;
...
SWIGINTERN PyObject *fz_document_s__getTrailerString(struct fz_document_s *self,int compressed){
            pdf_document *pdf = pdf_specifics(gctx, self); // conv doc to pdf
            if (!pdf) Py_RETURN_NONE;
            pdf_obj *obj = NULL;
            fz_buffer *res = NULL;
...
SWIGINTERN struct fz_annot_s *fz_page_s_addStrikeoutAnnot(struct fz_page_s *self,PyObject *arg){
            pdf_page *page = pdf_page_from_fz_page(gctx, self);
            fz_annot *annot = NULL;
            fz_var(annot);
            fz_try(gctx)
...
SWIGINTERN struct fz_annot_s *fz_page_s_addUnderlineAnnot(struct fz_page_s *self,PyObject *arg){
            pdf_page *page = pdf_page_from_fz_page(gctx, self);
            fz_annot *annot = NULL;
            fz_var(annot);
            fz_try(gctx)
...
SWIGINTERN struct fz_annot_s *fz_page_s_addSquigglyAnnot(struct fz_page_s *self,PyObject *arg){
            pdf_page *page = pdf_page_from_fz_page(gctx, self);
            fz_annot *annot = NULL;
            fz_var(annot);
            fz_try(gctx)
...
SWIGINTERN struct fz_annot_s *fz_page_s_addHighlightAnnot(struct fz_page_s *self,PyObject *arg){
            pdf_page *page = pdf_page_from_fz_page(gctx, self);
            fz_annot *annot = NULL;
            fz_var(annot);
            fz_try(gctx)
...
SWIGINTERN PyObject *fz_annot_s_vertices(struct fz_annot_s *self){
            pdf_annot *annot = pdf_annot_from_fz_annot(gctx, self);
            if (!annot) Py_RETURN_NONE;                  // not a PDF!
            PyObject *res = NONE;
            pdf_obj *o;
            //----------------------------------------------------------------
...
SWIGINTERN PyObject *fz_annot_s_lineEnds(struct fz_annot_s *self){
            pdf_annot *annot = pdf_annot_from_fz_annot(gctx, self);
            if (!annot) Py_RETURN_NONE;                   // no a PDF
            int i = pdf_annot_type(gctx, annot);
            // return nothing for invalid annot types
            if (!INRANGE(i, 2, 7)) Py_RETURN_NONE;
            if (INRANGE(i, 4, 5)) Py_RETURN_NONE;
...
SWIGINTERN PyObject *fz_stext_page_s__getBlockList(struct fz_stext_page_s *self,PyObject *list){
            fz_stext_block *block;
            int i = 0;
...
SWIGINTERN PyObject *fz_stext_page_s__getImageBlock(struct fz_stext_page_s *self,int blockno,PyObject *list){
            fz_stext_block *block;
            int i = -1;
            for (block = self->first_block; block; block = block->next)
            {
...
SWIGINTERN PyObject *fz_stext_page_s__getLineList(struct fz_stext_page_s *self,int blockno,PyObject *list){
            fz_stext_block *block;
            fz_stext_line *line;
            int i = -1, n = 0;
            for (block = self->first_block; block; block = block->next)
...
SWIGINTERN PyObject *fz_stext_page_s__getCharList(struct fz_stext_page_s *self,int blockno,int lineno,PyObject *list){
            fz_stext_block *block;
            fz_stext_line *line;
            fz_stext_char *ch;
            int i = -1, j = -1, n = 0;
...
SWIGINTERN PyObject *fz_stext_page_s__extractTextBlocks_AsList(struct fz_stext_page_s *self,PyObject *lines){
            fz_stext_block *block;
            fz_stext_line *line;
            fz_stext_char *ch;
            int block_n = 0;
...
SWIGINTERN PyObject *fz_stext_page_s__extractTextWords_AsList(struct fz_stext_page_s *self,PyObject *lines){
            fz_stext_block *block;
            fz_stext_line *line;
            fz_stext_char *ch;
            fz_buffer *buff = NULL;
...
SWIGINTERN PyObject *_wrap_Document_save(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "Document_save", 2, 11, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_fz_document_s, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_Document_write(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "Document_write", 1, 9, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_fz_document_s, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_Document_insertPDF(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "Document_insertPDF", 2, 7, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_fz_document_s, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_Document__getXrefString(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "Document__getXrefString", 2, 3, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_fz_document_s, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
  ...
  {
    result = (PyObject *)fz_document_s__getXrefString(arg1,arg2,arg3);
    if (!result)
    {
      PyErr_SetString(PyExc_RuntimeError, fz_caught_message(gctx));
      return NULL;
...
SWIGINTERN PyObject *_wrap_Document__getTrailerString(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "Document__getTrailerString", 1, 2, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_fz_document_s, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
  ...
  {
    result = (PyObject *)fz_document_s__getTrailerString(arg1,arg2);
    if (!result)
    {
      PyErr_SetString(PyExc_RuntimeError, fz_caught_message(gctx));
      return NULL;
...
SWIGINTERN PyObject *_wrap_Page_addTextAnnot(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "Page_addTextAnnot", 3, 3, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_fz_page_s, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_Page_addFileAnnot(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "Page_addFileAnnot", 4, 6, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_fz_page_s, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_Page_addStrikeoutAnnot(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "Page_addStrikeoutAnnot", 2, 2, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_fz_page_s, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_Page_addUnderlineAnnot(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "Page_addUnderlineAnnot", 2, 2, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_fz_page_s, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_Page_addSquigglyAnnot(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "Page_addSquigglyAnnot", 2, 2, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_fz_page_s, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_Page_addHighlightAnnot(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "Page_addHighlightAnnot", 2, 2, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_fz_page_s, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_Page_addRectAnnot(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "Page_addRectAnnot", 2, 2, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_fz_page_s, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_Page_addCircleAnnot(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "Page_addCircleAnnot", 2, 2, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_fz_page_s, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_Page_addPolylineAnnot(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "Page_addPolylineAnnot", 2, 2, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_fz_page_s, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_Page_addPolygonAnnot(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "Page_addPolygonAnnot", 2, 2, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_fz_page_s, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_Page_addFreetextAnnot(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "Page_addFreetextAnnot", 3, 7, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_fz_page_s, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_Page_deleteAnnot(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  arg1 = (struct fz_page_s *)(argp1);
  res2 = SWIG_ConvertPtr(swig_obj[1], &argp2,SWIGTYPE_p_fz_annot_s, 0 |  0 );
  if (!SWIG_IsOK(res2)) {
...
SWIGINTERN PyObject *_wrap_Pixmap_tintWith(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "Pixmap_tintWith", 4, 4, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_fz_pixmap_s, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_delete_Annot(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!args) SWIG_fail;
  swig_obj[0] = args;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_fz_annot_s, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_Annot_rect(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!args) SWIG_fail;
  swig_obj[0] = args;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_fz_annot_s, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_Annot_update(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "Annot_update", 1, 6, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_fz_annot_s, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_Annot_setColors(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "Annot_setColors", 2, 2, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_fz_annot_s, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_Annot_setBorder(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "Annot_setBorder", 2, 2, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_fz_annot_s, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_Annot__updateWidget(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "Annot__updateWidget", 2, 2, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_fz_annot_s, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_Annot__getWidget(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "Annot__getWidget", 2, 2, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_fz_annot_s, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_TextPage__getBlockList(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  struct fz_stext_page_s *arg1 = (struct fz_stext_page_s *) 0 ;
  PyObject *arg2 = (PyObject *) 0 ;
  void *argp1 = 0 ;
  ...
  if (!SWIG_Python_UnpackTuple(args, "TextPage__getBlockList", 2, 2, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_fz_stext_page_s, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "TextPage__getBlockList" "', argument " "1"" of type '" "struct fz_stext_page_s *""'"); 
  }
  arg1 = (struct fz_stext_page_s *)(argp1);
  arg2 = swig_obj[1];
  result = (PyObject *)fz_stext_page_s__getBlockList(arg1,arg2);
  resultobj = result;
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_TextPage__getImageBlock(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  struct fz_stext_page_s *arg1 = (struct fz_stext_page_s *) 0 ;
  int arg2 ;
  PyObject *arg3 = (PyObject *) 0 ;
  ...
  if (!SWIG_Python_UnpackTuple(args, "TextPage__getImageBlock", 3, 3, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_fz_stext_page_s, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "TextPage__getImageBlock" "', argument " "1"" of type '" "struct fz_stext_page_s *""'"); 
  }
  arg1 = (struct fz_stext_page_s *)(argp1);
  ecode2 = SWIG_AsVal_int(swig_obj[1], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "TextPage__getImageBlock" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = (int)(val2);
  arg3 = swig_obj[2];
  result = (PyObject *)fz_stext_page_s__getImageBlock(arg1,arg2,arg3);
  resultobj = result;
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_TextPage__getLineList(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  struct fz_stext_page_s *arg1 = (struct fz_stext_page_s *) 0 ;
  int arg2 ;
  PyObject *arg3 = (PyObject *) 0 ;
  ...
  if (!SWIG_Python_UnpackTuple(args, "TextPage__getLineList", 3, 3, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_fz_stext_page_s, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "TextPage__getLineList" "', argument " "1"" of type '" "struct fz_stext_page_s *""'"); 
  }
  arg1 = (struct fz_stext_page_s *)(argp1);
  ecode2 = SWIG_AsVal_int(swig_obj[1], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "TextPage__getLineList" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = (int)(val2);
  arg3 = swig_obj[2];
  result = (PyObject *)fz_stext_page_s__getLineList(arg1,arg2,arg3);
  resultobj = result;
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_TextPage__getCharList(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  struct fz_stext_page_s *arg1 = (struct fz_stext_page_s *) 0 ;
  int arg2 ;
  int arg3 ;
  ...
  if (!SWIG_Python_UnpackTuple(args, "TextPage__getCharList", 4, 4, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_fz_stext_page_s, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "TextPage__getCharList" "', argument " "1"" of type '" "struct fz_stext_page_s *""'"); 
  }
  arg1 = (struct fz_stext_page_s *)(argp1);
  ecode2 = SWIG_AsVal_int(swig_obj[1], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "TextPage__getCharList" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = (int)(val2);
  ecode3 = SWIG_AsVal_int(swig_obj[2], &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "TextPage__getCharList" "', argument " "3"" of type '" "int""'");
  } 
  arg3 = (int)(val3);
  arg4 = swig_obj[3];
  result = (PyObject *)fz_stext_page_s__getCharList(arg1,arg2,arg3,arg4);
  resultobj = result;
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_TextPage__extractTextBlocks_AsList(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "TextPage__extractTextBlocks_AsList", 2, 2, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_fz_stext_page_s, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
  ...
  arg2 = swig_obj[1];
  {
    result = (PyObject *)fz_stext_page_s__extractTextBlocks_AsList(arg1,arg2);
    if (!result)
    {
      PyErr_SetString(PyExc_RuntimeError, fz_caught_message(gctx));
      return NULL;
...
SWIGINTERN PyObject *_wrap_TextPage__extractTextWords_AsList(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "TextPage__extractTextWords_AsList", 2, 2, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_fz_stext_page_s, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
  ...
  arg2 = swig_obj[1];
  {
    result = (PyObject *)fz_stext_page_s__extractTextWords_AsList(arg1,arg2);
    if (!result)
    {
      PyErr_SetString(PyExc_RuntimeError, fz_caught_message(gctx));
      return NULL;
...
SWIGINTERN PyObject *_wrap_Tools__insert_contents(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "Tools__insert_contents", 4, 4, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_Tools, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "Document__getGCTXerrcode", _wrap_Document__getGCTXerrcode, METH_O, "Retrieve last MuPDF error code."},
	 { "Document__getGCTXerrmsg", _wrap_Document__getGCTXerrmsg, METH_O, "Retrieve last MuPDF error message."},
	 { "Document_authenticate", _wrap_Document_authenticate, METH_VARARGS, "Decrypt document with a password."},
	 { "Document_save", _wrap_Document_save, METH_VARARGS, "Document_save(self, filename, garbage=0, clean=0, deflate=0, incremental=0, ascii=0, expand=0, linear=0, pretty=0, decrypt=1) -> PyObject *"},
	 ...
	 { "Document_permissions", _wrap_Document_permissions, METH_O, "Get permissions dictionary."},
	 ...
	 { "Document__getXrefString", _wrap_Document__getXrefString, METH_VARARGS, "Document__getXrefString(self, xref, compressed=0) -> PyObject *"},
	 { "Document__getTrailerString", _wrap_Document__getTrailerString, METH_VARARGS, "Document__getTrailerString(self, compressed=0) -> PyObject *"},
	 ...
	 { "Page_getSVGimage", _wrap_Page_getSVGimage, METH_VARARGS, "Create an SVG image from the page as a string."},
	 ...
	 { "Page_addStrikeoutAnnot", _wrap_Page_addStrikeoutAnnot, METH_VARARGS, "Strike out content in a rectangle or quadrilateral."},
	 { "Page_addUnderlineAnnot", _wrap_Page_addUnderlineAnnot, METH_VARARGS, "Underline content in a rectangle or quadrilateral."},
	 { "Page_addSquigglyAnnot", _wrap_Page_addSquigglyAnnot, METH_VARARGS, "Wavy underline content in a rectangle or quadrilateral."},
	 { "Page_addHighlightAnnot", _wrap_Page_addHighlightAnnot, METH_VARARGS, "Highlight content in a rectangle or quadrilateral."},
	 { "Page_addRectAnnot", _wrap_Page_addRectAnnot, METH_VARARGS, "Add a 'Rectangle' annotation."},
	 { "Page_addCircleAnnot", _wrap_Page_addCircleAnnot, METH_VARARGS, "Add a 'Circle' annotation."},
	 { "Page_addPolylineAnnot", _wrap_Page_addPolylineAnnot, METH_VARARGS, "Add a 'Polyline' annotation for a sequence of points."},
	 { "Page_addPolygonAnnot", _wrap_Page_addPolygonAnnot, METH_VARARGS, "Add a 'Polygon' annotation for a sequence of points."},
	 ...
	 { "Page_getDisplayList", _wrap_Page_getDisplayList, METH_O, "Page_getDisplayList(self) -> DisplayList"},
	 ...
	 { "Pixmap_tintWith", _wrap_Pixmap_tintWith, METH_VARARGS, "Pixmap_tintWith(self, red, green, blue)"},
	 ...
	 { "Annot_setRect", _wrap_Annot_setRect, METH_VARARGS, "Annot_setRect(self, rect)"},
	 ...
	 { "Annot_widget_type", _wrap_Annot_widget_type, METH_O, "Annot_widget_type(self) -> PyObject *"},
	 { "Annot_widget_value", _wrap_Annot_widget_value, METH_O, "Annot_widget_value(self) -> PyObject *"},
	 { "Annot_widget_name", _wrap_Annot_widget_name, METH_O, "Annot_widget_name(self) -> PyObject *"},
	 { "Annot_widget_choices", _wrap_Annot_widget_choices, METH_O, "Annot_widget_choices(self) -> PyObject *"},
	 ...
	 { "Annot_setBorder", _wrap_Annot_setBorder, METH_VARARGS, "Annot_setBorder(self, border) -> PyObject *"},
	 ...
	 { "Annot_getPixmap", _wrap_Annot_getPixmap, METH_VARARGS, "Annot_getPixmap(self, matrix=None, colorspace=None, alpha=0) -> Pixmap"},
	 { "Annot__updateWidget", _wrap_Annot__updateWidget, METH_VARARGS, "Annot__updateWidget(self, Widget) -> PyObject *"},
	 { "Annot__getWidget", _wrap_Annot__getWidget, METH_VARARGS, "Annot__getWidget(self, Widget) -> PyObject *"},
	 ...
	 { "DisplayList_getPixmap", _wrap_DisplayList_getPixmap, METH_VARARGS, "DisplayList_getPixmap(self, matrix=None, colorspace=None, alpha=0, clip=None) -> Pixmap"},
	 ...
	 { "TextPage__getBlockList", _wrap_TextPage__getBlockList, METH_VARARGS, "TextPage__getBlockList(self, list) -> PyObject *"},
	 { "TextPage__getImageBlock", _wrap_TextPage__getImageBlock, METH_VARARGS, "TextPage__getImageBlock(self, blockno, list) -> PyObject *"},
	 { "TextPage__getLineList", _wrap_TextPage__getLineList, METH_VARARGS, "TextPage__getLineList(self, blockno, list) -> PyObject *"},
	 { "TextPage__getCharList", _wrap_TextPage__getCharList, METH_VARARGS, "TextPage__getCharList(self, blockno, lineno, list) -> PyObject *"},
	 { "TextPage__extractTextBlocks_AsList", _wrap_TextPage__extractTextBlocks_AsList, METH_VARARGS, "TextPage__extractTextBlocks_AsList(self, lines) -> PyObject *"},
	 { "TextPage__extractTextWords_AsList", _wrap_TextPage__extractTextWords_AsList, METH_VARARGS, "TextPage__extractTextWords_AsList(self, lines) -> PyObject *"},
	 ...
	 { "Tools__insert_contents", _wrap_Tools__insert_contents, METH_VARARGS, "Tools__insert_contents(self, fzpage, newcont, overlay) -> PyObject *"},
	 { "Tools_fitz_stdout", _wrap_Tools_fitz_stdout, METH_O, "Tools_fitz_stdout(self) -> PyObject *"},
	 { "Tools_fitz_stdout_reset", _wrap_Tools_fitz_stdout_reset, METH_O, "Empty fitz output log."},
	 { "Tools_fitz_stderr", _wrap_Tools_fitz_stderr, METH_O, "Tools_fitz_stderr(self) -> PyObject *"},
	 { "Tools_fitz_stderr_reset", _wrap_Tools_fitz_stderr_reset, METH_O, "Empty fitz error log."},
