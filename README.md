...
This is **version 1.16.19 of PyMuPDF (formerly python-fitz)**, a Python binding with support for [MuPDF](http://mupdf.com/) - "a lightweight PDF, XPS, and E-book viewer".
